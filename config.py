...
CHECK_TIMEOUT = 12                       # seconds, total per-proxy check budget; over this -> Dead
CHECK_CONNECT_TIMEOUT = 8               # seconds to establish the connection; dead proxies fail this fast
...
MAX_SCRAPE_ROUNDS = 6                    # safety cap: stop re-scraping for more if live_limit still isn't met
